...
class Sprinkler(Actuator):
    ...
    def __init__(self):
        ...
        self.device_uuid = 'sprinkler_001'  # todo: elimina dopo aver collegato il catalog
...
if __name__ == '__main__':
    ...
    try:
        ...
        logging.info(f"[{sprinkler.device_uuid}] Stopping actuator...")
    finally:
        sprinkler.shutdown()
